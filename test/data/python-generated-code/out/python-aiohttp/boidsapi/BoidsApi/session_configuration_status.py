...
from boidsapi.BoidsApi.base_model import Model
from boidsapi.BoidsApi.behavior_configuration import BehaviorConfiguration
from boidsapi.BoidsApi.session_state import SessionState
from boidsapi.BoidsApi.world_configuration import WorldConfiguration
...
class SessionConfigurationStatus(Model):
    ...
    def __init__(self, title: str=None, num_boids: int=None, state: SessionState=None, world: WorldConfiguration=None, behavior: BehaviorConfiguration=None, uuid: str=None, url: str=None, next_states: List[SessionState]=None, created: datetime=None, modified: datetime=None):
